def build_system_prompt(allow_patch=False):
    ...
    tools_section = (
        ...
        '8. `replace_lines`: {"filepath": "<str>", "start_line": <int>, "end_line": <int>, "content": "<str>"} - Replaces an existing range of lines with NEW content. Use this for LARGER edits (a whole function or more than 3 lines). Get start_line/end_line from the most recent successful `read_file` or `read_symbol` result for that SAME file.\n    '
